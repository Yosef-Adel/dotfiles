*bash.txt*  Bash Reference

==============================================================================
CONTENTS                                                        *bash-contents*

1. Basics ................................ |bash-basics|
2. Operators ............................. |bash-operators|
3. Conditionals .......................... |bash-conditionals|
4. Loops ................................. |bash-loops|
5. Functions ............................. |bash-functions|
6. Arrays ................................ |bash-arrays|
7. String Operations ..................... |bash-strings|
8. Advanced .............................. |bash-advanced|
9. Error Handling ........................ |bash-errors|
10. File Operations ...................... |bash-files|
...
String Operators~                                         *bash-string-ops*
>
...
Comparison Operators~                                      *bash-comparison*
>
    # Numeric
    [[ $a -eq $b ]]    # Equal
    [[ $a -ne $b ]]    # Not equal
...
Logical Operators~                                           *bash-logical*
>
    # AND
    [[ $a -gt 0 && $b -lt 10 ]]
    (( a > 0 && b < 10 ))
...
break/continue~                                          *bash-break-continue*
>
    # Break (exit loop)
    for i in {1..10}; do
      if [[ $i -eq 5 ]]; then
...
Define Function~                                        *bash-function-define*
>
    # Define function
...
Parameters~                                             *bash-function-params*
>
    # Access parameters
    my_func() {
      echo "First: $1"
...
Return Values~                                          *bash-function-return*
>
    # Capture stdout
    result=$(my_function)
    echo "$result"
...
Local Variables~                                         *bash-function-local*
>
    # Global variable
    global_var="global"
...
Associative Arrays~                                       *bash-array-assoc*
>
...
Variable Expansion~                                       *bash-expansion*
>
    # Basic expansion
    name="John"
    echo "$name"
...
String Manipulation~                                       *bash-string-manip*
>
    # Length
    str="hello"
    echo "${#str}"          # 5
...
Pattern Matching~                                         *bash-pattern-match*
>
...
Command Substitution~                                         *bash-subst*
>
    # Subshell: $()
...
Process Substitution~                                    *bash-process-subst*
>
    # Compare files
...
Test Operators~                                            *bash-file-tests*
>
    # File tests
...
File Manipulation~                                           *bash-file-ops*
>
    # Create file
    touch newfile.txt
