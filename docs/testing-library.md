...
Quick reference for React Testing Library and DOM Testing Library.

## Table of Contents

- [Queries](#queries)
  - [Single Element Queries](#single-element-queries)
  - [Multiple Element Queries](#multiple-element-queries)
